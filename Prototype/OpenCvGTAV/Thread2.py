...
conn= sqlite3.connect('..//..//bizhawk//output//DQN.db',isolation_level=None)
cur= conn.cursor()
...
def check_table():
    sql = "Select * from rewards where image is NULL"
    cur.execute(sql)
